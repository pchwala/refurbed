...
class SheetOperations:
    ...
    def __init__(self, orders_sheet, config_sheet, archive_sheet):
        """
    ...
    def archive_orders(self):
        ...
        try:
            ...
            print("Column 'r_state' not found in orders sheet")
            return
        ...
        if completed_orders:
            ...
            print(f"Archived {amount} completed orders")
            ...
            print("No completed orders to archive")
            return None
        ...
        if rows_to_write:
            ...
            print(f"Kept {len(active_orders)} active orders in orders sheet")
